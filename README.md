...
```
./batch_compile_mibench.py samples/protection_dataset -ob flatten.0 -ob virt.0 -ob opaque.0 -ob subst.0 -ob indir.0 -ob flatten.10 -ob virt.10 -ob opaque.10 -ob subst.10 -ob indir.10 -ob flatten.20 -ob virt.20 -ob opaque.20 -ob subst.20 -ob indir.20 -ob none.0 --seeds=11 --connectivity=11 -o samples/protection_dataset_bin --build-dir mibench_build -j3
```
